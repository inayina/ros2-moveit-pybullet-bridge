...
完整实验说明见 **[EXPERIMENTS.md](EXPERIMENTS.md)**。

| 脚本 | 产出 |
|------|------|
| `./scripts/run_dual_repo_integration.sh` | 双仓库联调报告 · `docs/samples/dual-repo-experiment-report.html` |
| `./scripts/run_same_task_calibration.sh` | 同任务校准报告 · `docs/samples/same-task-calibration-report.html` |
...
- [EXPERIMENTS.md](EXPERIMENTS.md) — **实验流水线、指标解读、报告对照**
